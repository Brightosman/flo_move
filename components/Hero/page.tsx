...
//       >
//         <Image src="/images/about/hero.png" alt='Hero Backgroung' width={900} height={900} />
...
//           >
//             {/* All polygon elements preserved here */}
//             <polygon points="327,163 361.2,206.1 419.5,206.1 378.5,261.3 404.8,326 327,294 249.2,326 275.5,261.3 234.5,206.1 292.8,206.1" fill="url(#paint0_linear_25:217)" />
//             <polygon points="277,63 291.2,86.1 319.5,86.1 298.5,105.3 304.8,133 277,117 249.2,133 255.5,105.3 234.5,86.1 262.8,86.1" fill="url(#paint0_linear_25:217)" />
//             <polygon points="17.9997,182 25.7997,195.1 44.4997,195.1 30.2997,208.2 34.1997,225.9 17.9997,217.2 1.79971,225.9 5.69971,208.2 -8.50029,195.1 10.1997,195.1" fill="url(#paint1_radial_25:217)" />
//             <polygon points="76.9997,288 88.4997,304.6 112.499,304.6 92.9997,318.2 98.6997,340.4 76.9997,328.6 55.2997,340.4 61.0997,318.2 41.5997,304.6 65.5997,304.6" fill="url(#paint2_radial_25:217)" />
//             <polygon points="325.486,302.87 341.787,324.011 377.094,324.011 349.634,344.244 359.935,372.926 325.486,356.079 291.037,372.926 301.338,344.244 273.878,324.011 309.185,324.011" transform="rotate(-37.6852 325.486 302.87)" fill="url(#paint3_linear_25:217)" />
//             <polygon opacity="0.8" points="184.521,315.521 196.823,331.786 222.33,331.786 202.677,345.632 212.451,372.346 184.521,357.112 156.59,372.346 166.364,345.632 146.711,331.786 172.218,331.786" transform="rotate(114.874 184.521 315.521)" stroke="url(#paint4_linear_25:217)" />
//             <polygon opacity="0.8" points="356,290 372.598,310.478 406.102,310.478 380.299,328.52 391.549,356.617 356,339.698 320.451,356.617 331.701,328.52 305.899,310.478 339.403,310.478" transform="rotate(-30 356 290)" stroke="url(#paint5_linear_25:217)" />
//             <polygon opacity="0.8" points="191.659,302.659 204.273,319.298 231.099,319.298 210.986,333.92 221.128,361.317 191.659,346.678 162.189,361.317 172.331,333.92 152.218,319.298 179.044,319.298" transform="rotate(133.319 191.659 302.659)" fill="url(#paint6_linear_25:217)" />
//             <defs>
...
//               </linearGradient>
//               <radialGradient id="paint1_radial_25:217" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17.9997 182) rotate(90) scale(34)">
...
//       <section className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-[#f9f7f3]">
//       {/* Left Text Block */}
//       <div className="max-w-xl text-center md:text-left">
//         <h1 className="text-4xl md:text-5xl font-bold text-[#1B5E20] mb-4">
//           Ireland’s Trusted Moving Experts
//         </h1>
...
//         <Image
//           src="/images/about/hero.png" // Place your PNG or SVG in /public/images/
//           alt="Irish Moving Truck Illustration"
//           width={600}
//           height={400}
...
export default function Hero() {
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-[#f9f7f3] relative z-10">
      {/* Left Text Block */}
      <div className="max-w-xl text-center md:text-left">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1B5E20] mb-4">
          Ireland’s Trusted Moving Experts
      ...
      {/* Right Image Block */}
      <div className="w-full md:w-1/2 mb-8 md:mb-0 relative z-0">
        <Image
